...
작업이 이미 진행되었는데 관련 issue가 없음을 인지·지적당하면, 즉시 작업을 멈추고 retroactive issue를 만듭니다. body와 핸드오프 메모에 retroactive 사유를 기록한 뒤 작업을 재개합니다. 같은 세션 내에서 동일 누락을 두 번째 반복하지 않도록 합니다.

...
- **AC2** (Ubiquitous): `allowed-tools` 에 `Bash(tail -F /private/tmp/claude-*/**/tasks/*.output*)` 패턴이 한 줄로 포함된다.
...
grep -qF 'Bash(tail -F /private/tmp/claude-*/**/tasks/*.output*)' plugins/autopilot/skills/loop/SKILL.md && \
